...
train_dir = "../../anh_train/data_pin/train"
test_dir = "../../anh_train/data_pin/test"
...
model.summary()
model.save("saved_trained_model_pin")

loaded_model = tf.keras.models.load_model("saved_trained_model_pin")
