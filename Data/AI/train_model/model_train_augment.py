...
train_dir = "../anh_train/dataset_face/dataset_face/train/"
test_dir = "../anh_train/dataset_face/dataset_face/test/"
...
model = tf.keras.models.Sequential([
    ...
    tf.keras.layers.Dense(1, activation="sigmoid"),  # 1 đầu ra  kích hoạt nhị phân(dùng sigmoid)
])
# biên dịch model
...
model.summary()
model.save("saved_trained_model_face.h5")

loaded_model = tf.keras.models.load_model("saved_trained_model_face.h5")
